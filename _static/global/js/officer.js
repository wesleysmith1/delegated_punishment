...
let officerGameComponent = {
    ...
    data: function () {
        return {
            ...
            overflowDefendTokens: [], // this is where tokens will be if there are too many to display
            showOverflow: true,
            minimumMovement: .01,
        }
    },
    created: function () {
        // sort so that functionality does not break if page is reloaded
