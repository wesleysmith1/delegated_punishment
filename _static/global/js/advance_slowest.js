...
var socketUrl = currentScript.getAttribute('socketUrl');
var isBrowserBot = currentScript.getAttribute('isBrowserBot');
var redirectUrl = currentScript.getAttribute('redirectUrl');
var isDebug = currentScript.getAttribute('isDebug');
...
console.log(socketUrl, redirectUrl)
